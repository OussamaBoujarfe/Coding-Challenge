...
<div class="container">
    <div class="row">
        ...
        <center><img src="<?php echo e(URL::asset("f/img/pu2.png")); ?>" height="245px" weidth="245px">
        <h1>Products List</h1>
         <div class="pull-right">
          <a href="<?php echo e(url('stocks/create')); ?>" class="btn btn-success">Add New Product? </a>
         </div>
         <div class="pull-left">
        <a href="<?php echo e(url('stocks/alld')); ?>" class="btn btn-danger">Sold Out Products </a>
...
<?php echo $__env->make('layouts.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Oussama Boujarfe\ecommerceV1\resources\views/stock/index.blade.php ENDPATH**/ ?>