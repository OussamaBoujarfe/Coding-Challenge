...
<div class="container">
    <div class="row">
     ...
     <center>   <img src="<?php echo e(URL::asset("f/img/pp.png")); ?>" height="110px" weidth="100px">
...
<?php echo $__env->make('layouts.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Oussama Boujarfe\ecommerceV1\resources\views/stock/alld.blade.php ENDPATH**/ ?>