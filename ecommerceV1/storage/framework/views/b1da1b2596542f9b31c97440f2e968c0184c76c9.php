...
<!--
  ...
  <div class="owl-carousel main-slider">
    <div class="item">
      <img src="for/assets/1.jpg" href="<?php echo e(url('/shop')); ?>" alt="">
      <div class="slider-inner-container">
        ...
        <a href="<?php echo e(route('product.index')); ?>" class="animate__animated animate__fadeInLeft animate__delay-.8s" >Shop now</a>
      </div>
    </div>
    <div class="item">
      <img src="for/assets/3.jpg" href="<?php echo e(url('/shop')); ?>" alt="">
      <div class="slider-inner-container">
        ...
        <div class="col-md-3 col-sm-6 ">
                  ...
                  <div class="product-card">
                    ...
                    <div class="add-to-cart-btn">
                      <a href="<?php echo e(route('product.addToCart1',['id'=>$product->id])); ?>">add to cart</a>
                    </div>
                  </div>
...
<?php echo $__env->make('layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Oussama Boujarfe\ecommerceV1\resources\views/welcome.blade.php ENDPATH**/ ?>