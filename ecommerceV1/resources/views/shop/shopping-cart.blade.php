                             ...
                             <table>
                              ...
                              <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td class="product_remove"><a href="{{ route('product.destroy', ['id' => $product['item']['id']]) }}"><i class="fa fa-trash-o"></i></a></td>
                                      <td class="product_thumb"><a href="#"><img src="{{$product['item']['imagePath']}}" alt=""></a></td>
                                      <td class="product_name"><a href="#">{{$product['item']['title']}}</a></td>
                                      <td class="product-price">{{$product['price']}}</td>
                                      <td class="product_quantity"><label></label> <input min="1" max="100" value="{{$product['qty']}}" type="number"></td>
